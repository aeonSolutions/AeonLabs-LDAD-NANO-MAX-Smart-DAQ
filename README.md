...
![](https://github.com/aeonSolutions/AeonLabs-LDAD-NANO-MAX-Smart-DAQ/blob/main/designs/working_yellow.png)  revision 6.1 Waiting for first batch from factory to be tested.
...
## Download options
Download this repository if you need the KiCad Files pr, download the Gerber files in the release section of this repository
